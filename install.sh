...
sudo pacman -S --needed kitty yazi stow zoxide fzf bleachbit lynis ripgrep neovim fd tldr bat xclip copyq eza btop fastfetch
...
# Apps
sudo pacman -S --needed ferdium-bin visual-studio-code-bin pix filelight vlc
